...
index = {"深":0, "秦":1, "京":2, "海":3, "成":4, "南":5, "杭":6, "苏":7, "松":8, "黑": 9, "苏": 10, "浙": 11, "皖": 12,
...
chars = ["深", "秦", "京", "海", "成", "南", "杭", "苏", "松", "黑", "苏", "浙", "皖", "闽", "赣", "鲁", "豫", "鄂", "湘", "粤", "桂",
...
class GenPlate:
    ...
    def __init__(self,fontCh,fontEng,NoPlates):
        ...
        self.img=np.array(Image.new("RGB", (297,70),(255,255,255)))
        self.bg  = cv2.resize(cv2.imread("./images/template.bmp"),(297,70));
    ...
    def generate(self,text):
        if len(text) == 9:
            fg = self.draw(text)#.encode(encoding="utf-8"));
    ...
    def genBatch(self, batchSize,pos,charRange, outputPath,size):
        ...
        for i in range(batchSize):
            ...
            outfile.write(plateStr+",  "+str(i).zfill(8) + ".jpg"+"\n")
